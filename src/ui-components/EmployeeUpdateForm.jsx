...
export default function EmployeeUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setNextOfKinPhoneNumber(cleanValues.nextOfKinPhoneNumber);
    setNextOfKinEmail(cleanValues.nextOfKinEmail);
    setNextOfKinRelationship(cleanValues.nextOfKinRelationship);
    setNextOfKinAddress(cleanValues.nextOfKinAddress);
    ...
    setEmploymentType(cleanValues.employmentType);
    setEmploymentStatus(cleanValues.employmentStatus);
    setEmploymentStartDate(cleanValues.employmentStartDate);
    setEmploymentEndDate(cleanValues.employmentEndDate);
    setEmploymentPosition(cleanValues.employmentPosition);
    setEmploymentDepartment(cleanValues.employmentDepartment);
    setEmploymentGrade(cleanValues.employmentGrade);
    setEmploymentLocation(cleanValues.employmentLocation);
    setGrossSalary(cleanValues.grossSalary);
    setBankAccountNumber(cleanValues.bankAccountNumber);
    setBankName(cleanValues.bankName);
    setBankBranchCode(cleanValues.bankBranchCode);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          nextOfKinPhoneNumber: nextOfKinPhoneNumber ?? null,
          ...
          employmentDepartment: employmentDepartment ?? null,
          employmentGrade: employmentGrade ?? null,
          employmentLocation: employmentLocation ?? null,
