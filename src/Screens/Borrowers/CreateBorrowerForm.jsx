...
const baseValidationSchema = Yup.object().shape({
  ...
  typeOfBusiness: Yup.string().matches(
    /^[^,"'!{}]+$/,
    "Invalid characters found. Cannot use , \" ' ! { }"
  ),
  uniqueNumber: Yup.string().matches(
    /^[^,"'!{}]+$/,
    "Invalid characters found. Cannot use , \" ' ! { }"
  ),
  mobile: Yup.string()
  ...
  employerName: Yup.string().matches(
    /^[^,"'!{}]+$/,
    "Invalid characters found. Cannot use , \" ' ! { }"
  ),
  creditScore: Yup.string().matches(
    /^[^,"'!{}]+$/,
    "Invalid characters found. Cannot use , \" ' ! { }"
  ),
});
...
export default function CreateBorrowerForm(props) {
  ...
  return (
    <>
      <SnackbarNotification message={submitSuccess} color="green" />
      <Box
        component="form"
      ...
      >
        <Typography variant="caption" sx={{ my: 2 }}>
          All fields are optional but you must provide at least First Name or
          Business Name.
        </Typography>
        ...
        <Grid container spacing={3}>
          ...
          <Typography variant="caption" sx={{ mt: -1, px: 2 }}>
            Do not put country code, spaces, or characters in the mobile field
            otherwise you won't be able to send SMS to the mobile.
          </Typography>
          ...
          <FormGrid size={{ xs: 12, md: 6 }}>
            ...
            <StyledOutlinedInput
              ...
              onChange={formik.handleChange}
              error={
                formik.touched.uniqueNumber &&
                Boolean(formik.errors.uniqueNumber)
              }
              onBlur={formik.handleBlur}
            />
            <Typography variant="caption" sx={{ mt: 1 }}>
              Enter a unique identifier for the borrower (e.g National ID,
              Social Security ID, License No., Registration No.)
            </Typography>
          ...
          <FormGrid size={{ xs: 12, md: 6 }}>
            ...
            {!showDobInput ? (
              ...
              <StyledOutlinedInput
                ...
                autoFocus
                onBlur={() => {
                  if (!formik.values.dob) setShowDobInput(false);
                }}
          ...
          <FormGrid size={{ xs: 12, md: 6 }}>
            ...
            <StyledOutlinedInput
              ...
              onChange={formik.handleChange}
              error={
                formik.touched.creditScore && Boolean(formik.errors.creditScore)
              }
              onBlur={formik.handleBlur}
            />
        ...
        >
          ...
          >
            <Link component={RouterLink} to="/customFields">
              Need to add custom fields?{" "}
              <b>Click here to manage custom fields</b>
            </Link>
          </Box>
        </Box>
      </Box>
