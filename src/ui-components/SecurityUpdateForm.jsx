...
import { getSecurity } from "../graphql/queries";
import { updateSecurity } from "../graphql/mutations";
const client = generateClient();
export default function SecurityUpdateForm(props) {
  const {
    id: idProp,
    security: securityModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    ...
    setCustomSecurityDetails(
      typeof cleanValues.customSecurityDetails === "string" ||
        ...
        ? cleanValues.customSecurityDetails
        : JSON.stringify(cleanValues.customSecurityDetails)
    );
    setErrors({});
  };
  ...
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getSecurity.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getSecurity
        : securityModelProp;
    ...
    queryData();
  }, [idProp, securityModelProp]);
  React.useEffect(resetStateValues, [securityRecord]);
  const validations = {
    name: [],
    type: [],
    description: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateSecurity.replaceAll("__typename", ""),
            variables: {
              input: {
      ...
      {...getOverrideProps(overrides, "SecurityUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || securityModelProp)}
