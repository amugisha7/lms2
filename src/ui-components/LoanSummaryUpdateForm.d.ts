...
export declare type LoanSummaryUpdateFormInputValues = {
    loanID?: string;
    refreshScope?: string;
...
export declare type LoanSummaryUpdateFormValidationValues = {
...
export declare type LoanSummaryUpdateFormOverridesProps = {
    LoanSummaryUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type LoanSummaryUpdateFormProps = React.PropsWithChildren<{
    overrides?: LoanSummaryUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    loanSummary?: any;
    onSubmit?: (fields: LoanSummaryUpdateFormInputValues) => LoanSummaryUpdateFormInputValues;
    onSuccess?: (fields: LoanSummaryUpdateFormInputValues) => void;
    onError?: (fields: LoanSummaryUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: LoanSummaryUpdateFormInputValues) => LoanSummaryUpdateFormInputValues;
    onValidate?: LoanSummaryUpdateFormValidationValues;
} & React.CSSProperties>;
export default function LoanSummaryUpdateForm(props: LoanSummaryUpdateFormProps): React.ReactElement;
