...
import { createLoanDraft } from "../graphql/mutations";
const client = generateClient();
export default function LoanDraftCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setDraftNumber(initialValues.draftNumber);
    ...
    setCreatedByEmployeeID(initialValues.createdByEmployeeID);
    setAssignedToEmployeeID(initialValues.assignedToEmployeeID);
    setSubmittedAt(initialValues.submittedAt);
    setApprovedAt(initialValues.approvedAt);
    setRejectedAt(initialValues.rejectedAt);
    setRejectionReason(initialValues.rejectionReason);
    setConvertedAt(initialValues.convertedAt);
    setDraftRecord(initialValues.draftRecord);
    setTermsSnapshot(initialValues.termsSnapshot);
    setSchedulePreview(initialValues.schedulePreview);
    setScheduleHash(initialValues.scheduleHash);
    setEditVersion(initialValues.editVersion);
    setLastEditedByEmployeeID(initialValues.lastEditedByEmployeeID);
    setLastEditedAt(initialValues.lastEditedAt);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createLoanDraft.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LoanDraftCreateForm")}
      {...rest}
    >
      <SelectField
        label="Status"
