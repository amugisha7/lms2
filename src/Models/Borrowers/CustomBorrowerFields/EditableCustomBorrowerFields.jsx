...
import CustomBorrowerFields from "./CustomBorrowerFields";
...
const EditableCustomBorrowerFields = ({
  customFields = [],
  initialValues = {},
  onUpdateSuccess,
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    console.log("EditableCustomBorrowerFields Form Values:", values); // <-- Add this log
...
export default EditableCustomBorrowerFields;
