...
import { getChartOfAccounts } from "../graphql/queries";
import { updateChartOfAccounts } from "../graphql/mutations";
const client = generateClient();
export default function ChartOfAccountsUpdateForm(props) {
  const {
    id: idProp,
    chartOfAccounts: chartOfAccountsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = chartOfAccountsRecord
      ? { ...initialValues, ...chartOfAccountsRecord }
      : initialValues;
    ...
    setCustomChartOfAccountsDetails(
      typeof cleanValues.customChartOfAccountsDetails === "string" ||
        cleanValues.customChartOfAccountsDetails === null
        ? cleanValues.customChartOfAccountsDetails
        : JSON.stringify(cleanValues.customChartOfAccountsDetails)
    );
    setErrors({});
  };
  const [chartOfAccountsRecord, setChartOfAccountsRecord] = React.useState(
    chartOfAccountsModelProp
  );
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getChartOfAccounts.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getChartOfAccounts
        : chartOfAccountsModelProp;
      setChartOfAccountsRecord(record);
    };
    queryData();
  }, [idProp, chartOfAccountsModelProp]);
  React.useEffect(resetStateValues, [chartOfAccountsRecord]);
  const validations = {
    code: [{ type: "Required" }],
    name: [{ type: "Required" }],
    type: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          customChartOfAccountsDetails: customChartOfAccountsDetails ?? null,
        };
        ...
        try {
          ...
          await client.graphql({
            query: updateChartOfAccounts.replaceAll("__typename", ""),
            variables: {
              input: {
                id: chartOfAccountsRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "ChartOfAccountsUpdateForm")}
      {...rest}
    >
      <TextField
        label="Code"
      ...
      <TextAreaField
        ...
        isRequired={false}
        isReadOnly={false}
        value={customChartOfAccountsDetails}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || chartOfAccountsModelProp)}
