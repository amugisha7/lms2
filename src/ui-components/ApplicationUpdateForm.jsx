...
export default function ApplicationUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setApplicationNumber(cleanValues.applicationNumber);
    setRequestedPrincipalAmount(cleanValues.requestedPrincipalAmount);
    setRequestedTermMonths(cleanValues.requestedTermMonths);
    setRequestedFrequency(cleanValues.requestedFrequency);
    setApplicationDate(cleanValues.applicationDate);
    setStatus(cleanValues.status);
    setApplicationRecord(
      typeof cleanValues.applicationRecord === "string" ||
        cleanValues.applicationRecord === null
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          requestedPrincipalAmount: requestedPrincipalAmount ?? null,
          requestedTermMonths: requestedTermMonths ?? null,
          requestedFrequency: requestedFrequency ?? null,
