      ...
      <Grid container spacing={3}>
        ...
        <FormGrid size={{ xs: 12, md: 6 }}>
            ...
            <StyledSelect
              ...
              fullWidth
            >
              <MenuItem value="text" sx={{ '&:hover': { color: 'white' } }}>Text</MenuItem>
              <MenuItem value="number" sx={{ '&:hover': { color: 'white' } }}>Number</MenuItem>
              <MenuItem value="select" sx={{ '&:hover': { color: 'white' } }}>Dropdown</MenuItem>
              <MenuItem value="date" sx={{ '&:hover': { color: 'white' } }}>Date</MenuItem>
              <MenuItem value="textarea" sx={{ '&:hover': { color: 'white' } }}>Textarea</MenuItem>
            </StyledSelect>
