...
import { createLoanDraftEvent } from "../graphql/mutations";
const client = generateClient();
export default function LoanDraftEventCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setLoanDraftID(initialValues.loanDraftID);
    setEventAt(initialValues.eventAt);
    setEventType(initialValues.eventType);
    setActorEmployeeID(initialValues.actorEmployeeID);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createLoanDraftEvent.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LoanDraftEventCreateForm")}
      {...rest}
    >
      <TextField
        label="Loan draft id"
