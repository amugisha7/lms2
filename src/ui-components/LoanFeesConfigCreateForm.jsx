...
import { createLoanFeesConfig } from "../graphql/mutations";
const client = generateClient();
export default function LoanFeesConfigCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCalculationMethod(initialValues.calculationMethod);
    setDescription(initialValues.description);
    setPercentageBase(initialValues.percentageBase);
    setRate(initialValues.rate);
    setStatus(initialValues.status);
    setCustomLoanFeesConfigDetails(initialValues.customLoanFeesConfigDetails);
    setErrors({});
  };
  const validations = {
    name: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createLoanFeesConfig.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LoanFeesConfigCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
