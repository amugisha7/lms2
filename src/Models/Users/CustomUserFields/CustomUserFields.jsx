...
const CustomUserFields = ({
  ...
  const canUpdateUser = useHasPermission("update", "user");
    ...
    return (
      <>
        <Box sx={{ textAlign: "center", py: 4 }}>
          ...
          >
            You have not added any custom fields for Users.
          </Typography>
        </Box>
...
CustomUserFields.getCustomFieldsData = (customFields, formValues) => {
...
CustomUserFields.createInitialValues = (customFields) => {
