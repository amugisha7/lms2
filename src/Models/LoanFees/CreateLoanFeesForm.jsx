...
const FEE_CATEGORY_OPTIONS = [
  {
    ...
    label: "Non-Deductable Fee",
    helperText: "Separate line item, borrower pays this.",
  },
  {
    value: "deductable",
    label: "Deductable Fee",
    helperText: "Taken from loan amount, borrower receives less.",
  },
  {
    value: "capitalized",
    label: "Capitalized Fee",
    helperText: "Added to principal, interest charged on it.",
  },
];

export default function CreateLoanFeesForm({ onSuccess, onClose }) {
    ...
    <FormikProvider value={formik}>
      ...
      >
        ...
        <CreateFormButtons
          ...
          onClose={onClose}
          setEditMode={() => {}} // Dummy as this is create form
        />
      </Box>
    </FormikProvider>
  );
