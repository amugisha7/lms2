...
export default function LoanProductCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPrincipalAmountDefault(initialValues.principalAmountDefault);
    setInterestRateMin(initialValues.interestRateMin);
    setInterestRateMax(initialValues.interestRateMax);
    setInterestRateDefault(initialValues.interestRateDefault);
    setInterestCalculationMethod(initialValues.interestCalculationMethod);
    setInterestType(initialValues.interestType);
    setInterestPeriod(initialValues.interestPeriod);
    setTermDurationMin(initialValues.termDurationMin);
    setTermDurationMax(initialValues.termDurationMax);
    setTermDurationDefault(initialValues.termDurationDefault);
    setDurationPeriod(initialValues.durationPeriod);
    setRepaymentFrequency(initialValues.repaymentFrequency);
    setRepaymentOrder(initialValues.repaymentOrder);
    setExtendLoanAfterMaturity(initialValues.extendLoanAfterMaturity);
    setInterestTypeMaturity(initialValues.interestTypeMaturity);
    setCalculateInterestOn(initialValues.calculateInterestOn);
    setLoanInterestRateAfterMaturity(
      initialValues.loanInterestRateAfterMaturity
    );
    setRecurringPeriodAfterMaturityUnit(
      initialValues.recurringPeriodAfterMaturityUnit
    );
    setStatus(initialValues.status);
    setCustomLoanProductDetails(initialValues.customLoanProductDetails);
    setErrors({});
  };
  const validations = {
    name: [],
