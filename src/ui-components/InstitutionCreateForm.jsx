...
export default function InstitutionCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setTrialEndDate(initialValues.trialEndDate);
    setNextBillingDate(initialValues.nextBillingDate);
    setStripeCustomerID(initialValues.stripeCustomerID);
    setStripeSubscriptionID(initialValues.stripeSubscriptionID);
    setDefaultDateFormat(initialValues.defaultDateFormat);
    setDefaultCurrencyFormat(initialValues.defaultCurrencyFormat);
    setDefaultLanguage(initialValues.defaultLanguage);
    setRegulatoryRegion(initialValues.regulatoryRegion);
    setMaxUsers(initialValues.maxUsers);
    setMaxBranches(initialValues.maxBranches);
    setMaxStaffPerBranch(initialValues.maxStaffPerBranch);
    setSaccoFeaturesEnabled(initialValues.saccoFeaturesEnabled);
    setStaffManagementEnabled(initialValues.staffManagementEnabled);
    setPayrollEnabled(initialValues.payrollEnabled);
    setCollectionsModuleEnabled(initialValues.collectionsModuleEnabled);
    ...
    setCustomDocumentHeader(initialValues.customDocumentHeader);
    setCustomInstitutionDetails(initialValues.customInstitutionDetails);
    setErrors({});
  };
  const validations = {
    name: [],
