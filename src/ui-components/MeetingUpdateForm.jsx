...
export default function MeetingUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setMinutes(cleanValues.minutes);
    setAttendanceRecord(
      typeof cleanValues.attendanceRecord === "string" ||
        cleanValues.attendanceRecord === null
        ? cleanValues.attendanceRecord
        : JSON.stringify(cleanValues.attendanceRecord)
    );
    setResolutionsRecord(
      typeof cleanValues.resolutionsRecord === "string" ||
        cleanValues.resolutionsRecord === null
        ? cleanValues.resolutionsRecord
        : JSON.stringify(cleanValues.resolutionsRecord)
    );
    setCustomMeetingDetails(
      typeof cleanValues.customMeetingDetails === "string" ||
        cleanValues.customMeetingDetails === null
        ? cleanValues.customMeetingDetails
        : JSON.stringify(cleanValues.customMeetingDetails)
    );
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          resolutionsRecord: resolutionsRecord ?? null,
          customMeetingDetails: customMeetingDetails ?? null,
        };
